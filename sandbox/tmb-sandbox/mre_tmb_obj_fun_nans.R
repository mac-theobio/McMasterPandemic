...
bad_pars = c(params = -1.43421811593977, params = 1.46059475554851, params = 0.347686590828955,
             params = -0.156903402702948, tv_mult = -0.623829450857725, tv_mult = 0.858585880116585,
             tv_mult = 0.0414218002599234, tv_mult = 2.08964971098563)
