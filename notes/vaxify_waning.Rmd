...
The gist is that there is an additional vaccination layer (after the “two-dose protection” layer) that is for individuals whose two-dose immunity has waned. People can enter the waned layer from the two-dose protection layer in two ways:

- $S_{\rm two dose} \rightarrow S_{\rm waned}$, where $S$ = susceptible individuals, i.e. those that have never had a SARS-CoV-2 infection
- $R_{\rm two dose} \rightarrow R_{\rm waned}$, where $R$ = recovered, i.e. those that have at some point in the past had a natural infection. 

We allow individuals in the waned layer to be subject to a different vaccine efficacy, probability of asymptomatic infection, and probability of mild (vs severe) infection than in other vaccination layers. 
...
The simulation results in two distinct, small waves, followed by a much larger uptick towards the end of the simulation. We can see which groups are driving each wave if we stratify the simulation results by vaccination layer. The strata are:

- `unvax`: unvaccinated individuals
- `vaxdose1`: individuals who have received one dose but have not yet undergone the protective immune response
- `vaxprotect1`: individuals that are protected by one dose of the vaccine
- `vaxdose2`: individuals who have received two doses but have not yet undergone the protective immune response to the second dose of vaccine
- `vaxprotect2`: individuals that are protected by two doses of the vaccine
- `vaxwane2`: individuals who have received two doses of the vaccine, but their vaccine-derived immunity has waned
