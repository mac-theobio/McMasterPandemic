...
Checkings:
- Testing intensity $t$ is fixed [?] and is a parameter of the model, it is given through the reported information, dimension of $t$ is $\#/time$.
- $\omega_i$ is dimensionless $1/\#$. Possible definition of $\omega_i$:
