...
- $E1$: $S_u= \frac{\omega}{\omega+t (1-P_S) F(W_S)} N_0, S_n= N_0-S_u$, and $I_j=R_j=0 \ \forall j$.
...
\left[ \begin {array}{cc}
\beta (\omega+\gamma) + \gamma F2 (1-P_I) & \beta \omega + \gamma (\gamma+F2)\\
\beta \eta_1 F2 (1-P_I) & \beta \eta_1 (\gamma +F2)
\end {array} \right],
\\ 
G_{22} =
\left[ \begin {array}{cc}
...
- It seems, numerically, that $\cal{R_0}=\lambda_1$. (failed to proved it so far).
