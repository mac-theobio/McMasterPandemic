...
\begin{align}
1)\  d S_u/dt &= \omega_{S_n} S_n -\beta \frac{(I_u+I_n+I_p+I_t)}{N_0} S_u - f_{S_u} S_u \\
2)\ d S_n/dt &= f_{S_u} S_u - \omega_{S_n} S_n \\
3)\ d I_u/dt &= \beta \frac{(I_u+I_n+I_p+I_t)}{N_0} S_u + \omega_{I_n} I_n - f_{I_u} (1-P_{I_u}) I_u -f_{I_u} P_{I_u} I_u- \gamma I_u  \\
