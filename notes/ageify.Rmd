...
filename_prefix <- "Canada_subnational_ON_F_"
...
age_dist <- read_csv("../inst/params/mistry-cmats/Canada_subnational_ON_age_distribution_85.csv",
                     col_names = FALSE,
                     col_types = cols(.default = col_double()))
...
filename <- file.path("..", "inst", "params", "mistry-cmats",
                      "Canada_subnational_ON_M_overall_contact_matrix_85.csv")
