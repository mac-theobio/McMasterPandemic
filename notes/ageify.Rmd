...
## FIXME: set up file loading in this so it's clear it's
## relative to the MacPan home directory (not depending on
## the location of the file in which the function is being
## used)---check how read_params is defined
cmat <- mk_mistry_cmat()
...
Larger error in groups where there are more contacts...
