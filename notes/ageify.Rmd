...
## TODO: check if make_state can intialize at least the S
...
(*IP:*: what are the units on the `beta` "vector"/matrix? `beta0` in the param file? What are the implied units on `Cmat`? Should add units for these quantities in the documentation/included in param descriptions for parsets that ship with the package.)
