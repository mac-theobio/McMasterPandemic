...
- how should `pmat` be scaled? Should it be normalized?
    - BB: best way to adjust a contact matrix? set lead eigenvalue to 1? symmetrize?
- what data structure should we use for age-specific parameters other than `pmat` (e.g. $\delta$, the fraction of acute care cases that are fatal)
