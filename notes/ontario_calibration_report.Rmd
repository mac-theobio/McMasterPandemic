...
L1 <- load("../output/ontario_clean.RData")
L2 <- load("../output/ontario_calibration.RData")  ## g1=calib to all, g2=hospital only
L3 <- load("../output/epiestim.RData")
...
```{r pars}
invlink_trans(restore(ont_cal1$par,opt_pars))
```
...
i1 <- invlink_trans(restore(ont_cal1$par,f_args$opt_pars))
...
![](../output/epiestim_plot.png)

* **fixme**: check, adjust time base
