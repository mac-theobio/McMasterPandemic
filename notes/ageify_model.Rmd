...
```{r, message = FALSE}
popbyage <- read_csv(
  system.file("params", "mistry-cmats", "Canada_subnational_ON_age_distribution_85.csv",
...
pop_pei <- read_csv(
  system.file("params", "mistry-cmats", "Canada_subnational_PE_age_distribution_85.csv",
              package = "McMasterPandemic"),
  col_names = c("age", "pop")
)
