...
## Age-structures force of infection
...
```{r, message = FALSE}
popbyage <- read_csv(
  system.file("params", "mistry-cmats", "Canada_subnational_Ontario_age_distribution_85.csv",
              package = "McMasterPandemic"),
  col_names = c("age_group", "mistry_value")
)
household <- mk_mistry_Cmat(weights = c(household = 1,
                                        school = 0, 
                                        work = 0, 
                                        community = 0))
...
**Idea:** take the already-calibrated $\beta(t)$ values and translate them into this framework to look at the fit between the age-stratified observations and this simple model?
...
I'm not sure if this is the smart thing to do... I suppose I could compare simulation results between the two cases?
...
```{r}
household_ontario <- mk_mistry_Cmat(weights = c(household = 1,
                                                school = 0,
                                                work = 0,
                                                community = 0))
household_pei <- mk_mistry_Cmat(weights = c(household = 1,
                                                school = 0,
                                                work = 0,
                                                community = 0),
...
pop_pei <- read_csv(
  system.file("params", "mistry-cmats", "Canada_subnational_Prince_Edward_Island_age_distribution_85.csv",
              package = "McMasterPandemic"),
  col_names = c("age", "pop")
)
