...
- Why does correlation *decreases* with large $\phi$ when testing and prevalence are low ... ?? (Seems real; simulation test agrees with calculations.) (Might be obvious if we draw the pictures as above for $phi = \{0.1, 0.375, 0.9\}$ to see what's happening.)
