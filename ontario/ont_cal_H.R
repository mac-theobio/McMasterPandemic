...
opt_pars_2brk$logit_rel_beta0 <- rep(-1,2)  ## only two breakpoints (hosp data doesn't even start until after brk 1)
...
ont_cal2 <- update(ont_cal1
                ,  data=ont_recent_hosp
                , opt_pars=opt_pars_2brk
