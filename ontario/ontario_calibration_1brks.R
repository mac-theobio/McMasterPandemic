...
opt_pars_1brks$log_rel_beta0 <- -1  ## only two breakpoints (hosp data doesn't even start until after brk 1)
bd1 <- as.Date("2020-03-20")
ont_cal_1brks <- update(ont_cal1,  opt_pars=opt_pars_1brks, break_dates=bd1)
