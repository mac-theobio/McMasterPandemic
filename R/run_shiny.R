...
##' @importFrom ggplot2 scale_y_continuous theme_gray geom_step element_text scale_x_date labs element_rect element_blank
...
#Everything else.
  server <- function(input, output, session){
    ...
    output$plot <- renderPlot({
        ...
        p <- p + scale_x_date(date_breaks = "1 month", date_labels = "%B") + labs(x = "Date", y = "Daily count", title = "Pandemic Simulation")
      ...
      loadParams <- function(param){
        ...
        textInput_param <- function(param, dp = dp_1){
          ...
          return(sliderInput(param,
                           label = paste(param, ": ", dp[dp$symbol == param,"meaning"], sep = ""),
