...
* [0.0.6 -- Updates of time-varying parameters from the initial parameters on the `C++` side](#v0.0.6)
* [0.1.0 -- Model structure](#v0.1.0)
* [0.1.1 -- Log-linear exogenous time-variation of parameters](#v0.1.1)
...
[![Lifecycle Badge](https://img.shields.io/static/v1.svg?label=Lifecycle&message=Experimental&color=red)](https://canmod.net/misc/flex_specs#versioning-and-lifecycle)
