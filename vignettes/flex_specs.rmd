...
* _Mathematical Description_ -- precise definition of the model; refer to previous versions for definitions being reused
...
* If `make_state` is used to create the `state_pansim` object, `vaxify`, `ageify`, and `testify` are all set to `FALSE`
