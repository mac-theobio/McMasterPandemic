...
-   [0.2.0 -- Condensation, calibration, and observation error on the `C++` side](#v0.2.0)
...
-   [0.2.2 -- Log-linear time-variation of parameters](#v0.2.2)
...
[![Lifecycle
Badge](https://img.shields.io/static/v1.svg?label=Lifecycle&message=Recommended&color=green)](https://canmod.net/misc/flex_specs#versioning-and-lifecycle)
...
The first step, `flexmodel`, in this pipeline initializes the
