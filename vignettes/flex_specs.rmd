...
1. Any state variable
2. Element-wise sum of any set of state variables
3. Any time-varying rate matrix element
4. Element-wise product of any two variables of type 1-3
5. Element-wise Sum of any variable of type 4
6. Lag-1 differences of any variables of type 1-5
7. Convolutions of any variables of type 1-5 with a gamma-density kernel (see section below on computing convolutions)
