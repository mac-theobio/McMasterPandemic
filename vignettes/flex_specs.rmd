---
title: "Flexible Modelling Specifications"
author: "Steve Walker, Weiguang Guan, Ben Bolker"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Flexible Modelling Specifications}
...
We are using semantic versioning https://semver.org/ to provide versions for the specs themselves. All versions of the spec that have not been implemented in a released McMasterPandemic R package have pre-release `-alpha-x` identifiers (https://semver.org/#spec-item-9).
...
Versions of the spec that are marked as '[future]' define the roadmap and only need to contain the _New Capabilities_ section.

# [future] 0.0.1-alpha-4

## New Capabilities 0.0.1-alpha-4
...
# [future] 0.0.1-alpha-3

## New Capabilities (0.0.1-alpha-3)
...
# [future] 0.0.1-alpha-2

## New Capabilities (0.0.1-alpha-2)

Iterated updates of the state vector.

## Assumptions (0.0.1-alpha-2)
...
7. Assumptions 2-4 from 0.0.1-alpha-1

## Mathematical Description (0.0.1-alpha-2)
...
* The number of iterations of the state matrix

# [future] 0.0.1-alpha-1

## New Capabilities (0.0.1-alpha-1)
...
## Mathematical Description (0.0.1-alpha-1)
