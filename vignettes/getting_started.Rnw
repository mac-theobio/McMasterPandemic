...
## Matt: Careful! Warnings are now suppressed, as the getting_started vignette
## causes a LOT of negative state value warnings.
options(warn=-1)
@
...
opt_pars <- list(time_params = c(value=0.1))
